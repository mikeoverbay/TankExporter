...
Module mod_glTF
    ...
    Public Sub import_glTF()
        ...
        Dim tfp As String = "C:\"
        If File.Exists(Temp_Storage + "\GLTF_in_folder.txt") Then
            tfp = File.ReadAllText(Temp_Storage + "\GLTF_in_folder.txt")
        End If
        ...
        If Not frmMain.OpenFileDialog1.ShowDialog = Forms.DialogResult.OK Then
            Return
        End If
        File.WriteAllText(Temp_Storage + "\GLTF_in_folder.txt", Path.GetDirectoryName(frmMain.OpenFileDialog1.FileName))

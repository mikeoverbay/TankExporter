...
void main(void){
    ...
    //============================================
    vec4 colorAM_1 = texture2DLod(atlasMap,UV1,0.0);
    vec4 colorAM_2 = texture2DLod(atlasMap,UV2,0.0);
    vec4 colorAM_3 = texture2DLod(atlasMap,UV3,0.0);

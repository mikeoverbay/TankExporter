...
#End Region
    ...
    Private Sub frmShaderEditor_FormClosing(sender As Object, e As FormClosingEventArgs) Handles Me.FormClosing
        stop_updating = False
        frmMain.m_pick_camo.Enabled = True
        frmMain.show_textures_cb.Enabled = True

    End Sub

    Private Sub frmShaderEditor_Load(sender As Object, e As EventArgs) Handles Me.Load

        TabControl1.Width = Me.ClientSize.Width
        TabControl1.Location = New Point(0, 0)
        all_updates_cb.Checked = False
        ...
        AddHandler vert_tb.MouseDown, AddressOf tb_mouseDown
        AddHandler frag_tb.MouseDown, AddressOf tb_mouseDown
        AddHandler geo_tb.MouseDown, AddressOf tb_mouseDown

        AddHandler vert_tb.MouseMove, AddressOf tb_mouseMove
        AddHandler frag_tb.MouseMove, AddressOf tb_mouseMove
        AddHandler geo_tb.MouseMove, AddressOf tb_mouseMove

        AddHandler vert_tb.MouseUp, AddressOf tb_mouseUp
        AddHandler frag_tb.MouseUp, AddressOf tb_mouseUp
        AddHandler geo_tb.MouseUp, AddressOf tb_mouseUp
    ...
    Public m_down_ As Boolean
    Private Sub tb_mouseDown(sender As FastColoredTextBox, e As EventArgs)
        m_down_ = True
    End Sub
    Private Sub tb_mouseMove(sender As FastColoredTextBox, e As EventArgs)

    End Sub
    Private Sub tb_mouseUp(sender As FastColoredTextBox, e As EventArgs)
        m_down_ = False
    End Sub
    ...
    Private Sub all_updates_cb_CheckedChanged(sender As Object, e As EventArgs) Handles all_updates_cb.CheckedChanged
        If all_updates_cb.Checked Then
            stop_updating = False
        Else
            stop_updating = True
        End If
